...
const TopNavbar = ({ user = { firstName: 'John', lastName: 'Doe' }, showUserMenu = true }) => {
    ...
    <>
      <style>{`
        ...
        .logout-button:hover {
          ...
          box-shadow: 0 8px 25px rgba(165, 8, 5, 0.4);
        }
            ...
            {showUserMenu && (
              <div className="flex items-center space-x-4">
                ...
                <div className="hidden md:block text-right">
                  ...
                  <p className="text-sm font-semibold text-[#624d41]">{user.firstName} {user.lastName}</p>
                </div>
                  ...
                  <div className={`user-menu ${isUserMenuOpen ? 'open' : ''}`}>
                    <div className="p-2">
                      <div className="px-3 py-2 border-b border-gray-200 mb-2">
                        <p className="font-semibold text-[#624d41] text-sm">{user.firstName} {user.lastName}</p>
                        <p className="text-xs text-[#b6b1b2]">john.doe@example.com</p>
                      </div>
