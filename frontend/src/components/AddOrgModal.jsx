...
const AddOrgModal = ({ isOpen, onClose, onSave }) => {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4">
      <div className="bg-white rounded-2xl shadow-2xl max-w-lg w-full transform transition-all duration-300 scale-100 animate-in fade-in-0 zoom-in-95">
          ...
          <div className="flex items-center space-x-3">
            <div className="bg-[#a50805] p-2 rounded-lg">
              <svg className="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2 2v2m8 0V8a2 2 0 01-2 2H6a2 2 0 01-2-2V6m8 0H6m12 8v3a2 2 0 01-2 2H6a2 2 0 01-2-2v-3"></path>
              </svg>
            </div>
            <h3 className="text-xl font-bold text-[#624d41]">Add New Organization</h3>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-6">
          ...
          <div>
            <label className="block text-[#624d41] font-semibold mb-2 text-sm">Description</label>
            <div className="relative">
              ...
              <textarea
                ...
                rows="3"
                className="w-full pl-10 pr-4 py-3 border border-[#e9ecef] rounded-lg focus:outline-none focus:ring-2 focus:ring-[#a50805] focus:border-[#a50805] transition-all duration-200 resize-none"
                disabled={isSubmitting}
              />
            </div>
          </div>
          ...
          <div>
            <label className="block text-[#624d41] font-semibold mb-2 text-sm">Type</label>
            <div className="relative">
              <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                <svg className="w-5 h-5 text-[#b6b1b2]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
